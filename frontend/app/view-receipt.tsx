    ...
    <ScreenShell>
      <View style={styles.container}>
        ...
        >
          ...
          {!loading && !error && filtered.length === 0 ? <Text style={styles.emptyText}>No receipts yet.</Text> : null}
          ...
          {filtered.map((item) => (
            <Pressable
              ...
              onPress={() => router.push(`/receipt-details/${item.receiptId}`)}
            >
          ...
          <Pressable style={styles.addReceiptWrap} onPress={() => router.push('/scan')}>
