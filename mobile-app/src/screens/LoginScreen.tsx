  ...
  return (
    <ScreenShell>
      ...
      >
        ...
        <Pressable style={[styles.primaryTap, styles.mb24]} onPress={() => navigation.navigate('Description')}>
          <Text style={styles.primaryText}>Login to Your Account</Text>
        </Pressable>
        <Text style={[styles.or, styles.mb24]}>Or</Text>
        <Pressable style={styles.linkHit} onPress={() => navigation.navigate('SignUp')}>
